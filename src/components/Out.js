...
function Signout(){
  ...
  function out(e){
    ...
    fetch("https://gymupbackend.herokuapp.com/out", sendmethod)
    .then( (res) => res.json() )
    .then( ( message ) => {
            ...
            <div class="row">
                <div className="col-11 col-lg-6 formulario m-1">
                    ...
                    <form onSubmit={out}>
                        ...
                        <div class="col-lg-12 col-12 form-outline mb-2 text-start ">

                            Username Or Password
                            <label class="form-label border border-secondary mt-2 mx-1 w-50" for="form1Example1" >
                        ...
                        Password
                        <label class="form-label border border-secondary mt-0 w-75 " for="form1Example1" >
